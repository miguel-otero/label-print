...
class AgentConfig:
    ...
    def load(cls, path: Path | None = None) -> "AgentConfig":
        ...
        return cls(
            ...
            poll_seconds=float(os.environ.get("CLINIC_AGENT_POLL_SECONDS", "1")),
            heartbeat_seconds=float(os.environ.get("CLINIC_AGENT_HEARTBEAT_SECONDS", "10")),
            request_timeout_seconds=float(os.environ.get("CLINIC_AGENT_REQUEST_TIMEOUT_SECONDS", "15")),
        )
